...
export const AddNewArtist = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-evenly w-full flex-wrap">
      <p
      ...
      >
        ...
        <div className="w-full flex-col lg:w-300 flex items-center justify-center lg:justify-end">
          {isArtist ? (
            <DisabledButton />
          ) : (
            <motion.button
...
export const AddNewAlbum = () => {
  ...
  return (
    <div
      className="flex flex-col items-center justify-evenly w-full flex-wrap"
